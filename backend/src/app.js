...
app.use('/api/inventory/batches', require('./modules/inventory/batch.routes'));
app.use('/api/inventory/purchase-returns', require('./modules/inventory/purchaseReturn.routes'));
app.use('/api/inventory/branch-orders', require('./modules/inventory/branchOrder.routes'));
