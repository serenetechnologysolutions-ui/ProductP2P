...
import { Table, Button, Form, Input, Tag, Space, Card, Popconfirm, message } from 'antd';
import { PlusOutlined, EditOutlined, DeleteOutlined, SaveOutlined } from '@ant-design/icons';
import api from '../api/axios';

// Generic CRUD tab for one sub_masters category — shared by SubMasters.jsx
// (vendor-related categories) and ProcurementSubMasters.jsx (procurement-
// related categories), since both manage the exact same /sub-masters API.
